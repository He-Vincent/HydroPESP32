...
DFRobot_PH::DFRobot_PH()
{
    ...
    // YOUR SENSOR'S DEFAULT VALUES
    // pH 4 -> approximately 3150 mV
    // pH 7 -> approximately 2500 mV
    this->_acidVoltage = 3150.0;
...
void DFRobot_PH::begin()
{
    ...
    Serial.print("pH neutral voltage: ");
    Serial.println(this->_neutralVoltage);

    Serial.print("pH acid voltage: ");
    Serial.println(this->_acidVoltage);
}
...
float DFRobot_PH::readPH(float voltage, float temperature)
{
    ...
    float intercept =
        6.86 - slope * this->_neutralVoltage;
...
void DFRobot_PH::phCalibration(byte mode)
{
    ...
    switch (mode) {
        ...
        case 1:
            ...
            Serial.println();
            Serial.println(F(">>>Enter PH Calibration Mode<<<"));
            Serial.println(F(">>>Put probe into pH 4.0 or pH 7.0 buffer<<<"));
            Serial.println();
        ...
        case 2:
            ...
            if (enterCalibrationFlag) {
                ...
                // YOUR pH 7 BUFFER
                // Expected around 2500 mV
                if ((this->_voltage > 2200) &&
                    (this->_voltage < 2800))
                {
                    Serial.println();
                    Serial.print(F(">>>Buffer Solution: 7.0"));
                ...
                // YOUR pH 4 BUFFER
                // Expected around 3150 mV
                else if ((this->_voltage > 2800) &&
                         (this->_voltage < 3400))
                {
                    Serial.println();
                    Serial.print(F(">>>Buffer Solution: 4.0"));
                    ...
                    Serial.println();
                    Serial.println(F(">>>Buffer Solution Error<<<"));

                    Serial.print(F("Voltage: "));
                    Serial.print(this->_voltage);
                    Serial.println(F(" mV"));

                    Serial.println(F("Expected approximately:"));
                    Serial.println(F("pH 7 = 2200-2800 mV"));
                    Serial.println(F("pH 4 = 2800-3400 mV"));
        ...
        case 3:
            ...
            if (enterCalibrationFlag) {
                ...
                if (phCalibrationFinish) {
                    ...
                    Serial.print(F("pH 7 voltage: "));
                    Serial.print(this->_neutralVoltage);
                    Serial.println(F(" mV"));

                    Serial.print(F("pH 4 voltage: "));
